...
public class LayoutService_backup {
	private static LayoutService_backup endpointService;

	private LayoutService_backup() {
	}

	public static LayoutService_backup getInstance() {
		return endpointService == null ? new LayoutService_backup() : endpointService;
	}
